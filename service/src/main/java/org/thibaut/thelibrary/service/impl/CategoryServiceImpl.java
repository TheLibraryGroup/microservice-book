...
public class CategoryServiceImpl implements CategoryService {
	...
	public CategoryDTO findById( Long id ){
		return CategoryMapper.INSTANCE.toDTO( categoryRepository.getOne( id ) );
	}


	@Override
	public CategoryDTO findByName( String name ){
		return CategoryMapper.INSTANCE.toDTO( categoryRepository.findCategoryEntityByCategoryContains( name ));
	}
